...
def main():
    ...
    dmd = DMD(params, min_func, step_func, control_dist, state_uncertainty, sub_opt_depth, path_str_center, learn_rate=1e-3)
    vec = dmd.step()
    

    # # test - drive straight as fast as you can
    # right_edge = [0, 0, 0, 3]
    # left_edge = [0, 0, 0, -3]
    # commands = []
    # for i in range(300):
    #     commands.append([0.3, 0.01])
    #
